...
import (
	...
	"github.com/tiaguin061/fclx/chatservice/internal/domain/entity"
	"github.com/tiaguin061/fclx/chatservice/internal/domain/gateway"
)
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		return nil, errors.New("error saving cghat:" + err.Error())
	}
