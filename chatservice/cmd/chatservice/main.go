...
import (
	...
	"github.com/tiaguin061/fclx/chatservice/configs"
	"github.com/tiaguin061/fclx/chatservice/internal/infra/repository"
	"github.com/tiaguin061/fclx/chatservice/internal/infra/web"
	"github.com/tiaguin061/fclx/chatservice/internal/infra/web/webserver"
	"github.com/tiaguin061/fclx/chatservice/internal/usecase/chatcompletion"
)
...
func main() {
	...
	fmt.Printf("Server running on port" + configs.WebServerPort)
	webserver.Start()
}
